...
```{r}
# Example 1 - LASSO
# Alternatively, we could define an outcome column identifier argument, say, 'outcome_cols = 1' in 
# this function or just 'outcome_cols' and then set the argument as 'outcome_cols = 1' in train_model().
